      ...
      {(loginStatus == "failed" || loginStatus == "no") && (
        <div className="row bgc size p-3  login-container">
          ...
          <form action="" onSubmit={handleLoginFormSubmit}>
            ...
            <div className="row">
              <div className="col-6 text-white h4  text-end my-2">
            ...
            <div className="row">
              <div className="col-6 text-white h4 my-2 text-end">
                <label htmlFor="">Password:</label>
              </div>
              <div className="col-6 text-start y-2 ">
